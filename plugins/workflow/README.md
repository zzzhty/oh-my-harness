...
Planning preflight reuses existing decisions before asking material questions. Atomic goals and sequences use the same completed or explicitly skipped preflight contract; sequence registers must match every child. Time estimates are optional context and do not gate readiness.
