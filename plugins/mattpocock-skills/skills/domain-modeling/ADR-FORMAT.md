...
Apply the three-part decision gate in [the main skill](SKILL.md#offer-adrs-sparingly). The examples below are candidates, not exceptions to that gate or write authorization.
